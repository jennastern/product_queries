...
set @AO_Key = 66788 --update with AO Key
set @Query_Start_Date = '5/1/2021' --update with your query start date
set @Query_End_Date = '8/3/2021' --update with your query end date
...
inner join dbo.org_node p with (nolock)
on inst.parent_org_node_id = p.org_node_id
----------------------------------------------------------------------
...
( '552455CB-0469-E811-B6FF-005056B10E33',
  '078B750D-9A69-E811-9631-005056B1318B')
